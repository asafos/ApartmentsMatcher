import { Apartment, ApartmentToAdd } from "../../../DAL/services/apartments/apartments";
...
import { CheckboxControl, FormControl, NumberInputControl, SelectControl, SubmitButton } from "formik-chakra-ui";
                    ...
                    {(formProps) => {
                        ...
                        return (
                            <VStack spacing={4} align="flex-start">
                                <NumberInputControl isInvalid={!!errors.numberOfRooms && touched.numberOfRooms} name="numberOfRooms" label="Rooms" />
                                <NumberInputControl showStepper={false} isInvalid={!!errors.price && touched.price} name="price" label="Price" />
                                <SelectControl
                                    name="location"
